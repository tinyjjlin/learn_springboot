...
const calendar = {
  ...
  getDayInfo: function(y, m, d) {
    ...
    if (m == 1 && d == 1) {
      ...
      isHoliday = true
      holiday = '国庆节'
    } else if ((month == 12 && day == 30) || (month == 1 && day <= 6)) {
      isHoliday = true
      holiday = '春节'
    ...
    return { 'isHoliday': isHoliday, 'holiday': holiday, 'lYear': year, 'lMonth': month, 'lDay': day, 'cYear': y, 'cMonth': m, 'cDay': d, 'isToday': isToday, 'isLeap': isLeap, 'nWeek': nWeek, 'ncWeek': '\u661f\u671f' + cWeek }
  }
}

  ...
  <div>
    <el-form :model="form" ref="form" status-icon label-width="180px" :rules="rulesForm">
      ...
      <el-form-item label="婚姻状况(旧)" v-if="applicationTypeValue === 4">
        <el-input disabled :value="personalInfo.marriage"></el-input>
      </el-form-item>
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          if (this.form.applicationTypeValue === 1) {
            ...
            data.secondItemOldValue = this.personalInfo.bankCard;
            ...
            data.secondItemOldValue = this.personalInfo.emergencyContactPhone;

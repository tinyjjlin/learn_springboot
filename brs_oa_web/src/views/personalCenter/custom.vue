      ...
      <div id="style">
        ...
        <div class="profile-base-wrapper">
          ...
          <div class="person-base">
            <p>
              ...
              <span>{{ baseInfo.gender===0?'男':'女' }}</span>
        ...
        <div class="profile-info-wrapper">
          <div class="profile-info">
            <p class="info-title">基本信息</p>
            <div class="box-info" style="padding: 0 0 0 100px;" v-show="importantInfoStatus===0">
              <!-- <span class="profile-edit" v-if="btnObj.isShowEdit" @click="changeImportantInfoStatus(1)">
                <i class="el-icon-edit"></i>编辑
              </span>-->
              <ul class="per-info-ul" id="important">
                <li>
                ...
                <li>
                  <span>婚姻状况：{{importantInfo.maritalStatus===0?"未婚":"已婚"}}</span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span id="localContactNumber">本地紧急联系人电话：{{importantInfo.emergencyContactPhone}}</span>
                </li>
              </ul>
            </div>
            <!-- edit important info -->
        ...
        <div class="profile-info-wrapper">
          <div class="profile-info">
            ...
            <span
              ...
              @click="showEduEditPanel({isNationalUnified:0},0)"
            >
...
.profile-page {
  padding: 1% 130px 1px 0; 
}
#style {
  width: 1000px;
  height: 100%;
  color: #000;
  margin: 120px 22% 10px;
  border-radius: 10px;
  background: url('../../assets/images/timg2_meitu_3.jpg');

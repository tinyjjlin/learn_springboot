    ...
    children: [
      {
        ...
        name: 'myInfo',
        meta: { icon: 'component', title: 'myInfo', noCache: true }
      },
      {
      ...
      },
      {
        ...
        name: 'mySalarySheet',
        meta: { icon: 'component', title: 'mySalarySheet', noCache: true }
      },
      myAttendance,
      {
      ...
      {
        path: '/personalCenter/custom',
        component: () => import('@/views/personalCenter/custom'),
        name: 'custom',
        meta: {
          icon: 'component',
          title: 'custom',

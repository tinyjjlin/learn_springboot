<template>
  <div class="navbar">
    ...
    <div class="right-menu right-box">
      ...
      <!-- 签到 -->
      <el-button class="theme-switch right-menu-item sign-btn" size="mini" type="warning" @click="saveClockRecord('签到时间')"><svg-icon icon-class="sign" />  签到</el-button>
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img :src="'http://172.18.19.3:8066/'+avatar+'?imageView2/1/w/80/h/80'" class="user-avatar">
